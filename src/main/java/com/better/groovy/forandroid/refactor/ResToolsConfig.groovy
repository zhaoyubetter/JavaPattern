...
class ResToolsConfig {
    /**
     * 新的资源前缀
     */
    public String new_prefix = "better_";
    /**
     * 老的资源前缀，取值说明如下：
     * <p>
     * 1. 使用空字符串：
    ...
    public ResToolsConfig(String new_prefix, String old_prefix, String srcFolderPath, String resFolderPath, String manifestFilePath) {
